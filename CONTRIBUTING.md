...
- Run the tests with `python3 -m pytest tests/` (needs `pytest`); they cover the action-token
  signing/verification and the relay's handling of hostile ack-topic input — extend them when
  you touch either.
