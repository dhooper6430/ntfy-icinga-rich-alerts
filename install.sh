...
relay:
  ...
  state_file: "${INSTALL_DIR}/state/relay-cursor"
...
suppression:
  ...
  always_notify_types: [RECOVERY, ACKNOWLEDGEMENT, CUSTOM, FLAPPINGSTART, FLAPPINGEND, DOWNTIMESTART, DOWNTIMEEND, DOWNTIMEREMOVED]
routing:
